...
{
    [TextArea]
    public string noteText = "Тут заметка";
    public float displayTime = 5f;
    public Canvas noteCanvasPrefab;
    public bool NeedStop = false;
    public float textHeightOffset = 1.5f; // Высота над игроком
    public float textRightOffset = 1.0f;  // Смещение вправо от игрока
    ...
    IEnumerator ShowNoteCoroutine(Transform playerTransform)
    {
        ...
        while (timer < displayTime)
        {
            ...
            {
                // Спавним текст с высотой и сдвигом вправо
